				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="modelForm" 
							cssClass="form-horizontal form-label-left" servletRelativeAction="/product-info/save" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<c:choose>
										...
										<c:otherwise>
												<form:input path="category.name" cssClass="form-control col-md-7 col-xs-12" disabled="true" />
										</c:otherwise>
									</c:choose>
								</div>
							</div>
							...
							<c:if test="${!viewOnly}">
								<div class="form-group">
									<label for="multipartFile"
										class="control-label col-md-3 col-sm-3 col-xs-12">Image Upload</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
