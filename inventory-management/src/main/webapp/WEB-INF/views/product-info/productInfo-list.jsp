                  ...
                  <div class="x_content">
                  	...
                  	<div class="container" style="padding: 50px;">
                  		<form:form modelAttribute="searchForm" 
							cssClass="form-horizontal form-label-left" servletRelativeAction="/product-info/list/1" method="POST">
...
<script type="text/javascript">
	...
	function goToPage(pageIndex) {
		$('#searchForm').attr('action', '<c:url value="/product-info/list/"/>' + pageIndex);
		$('#searchForm').submit();
	}
