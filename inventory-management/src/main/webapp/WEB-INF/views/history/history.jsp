                  ...
                  <div class="x_content">
                  	...
                  	<div class="container" style="padding: 50px;">
                  		<form:form modelAttribute="searchForm" 
							cssClass="form-horizontal form-label-left" servletRelativeAction="/history/list/1" method="POST">
							
							<div class="form-group">
								<label for="productInfo.category.name" class="control-label col-md-3 col-sm-3 col-xs-12">Category</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="productInfo.category.name" cssClass="form-control col-md-7 col-xs-12" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="productInfo.code">Code</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
...
<script type="text/javascript">
	...
	function goToPage(pageIndex) {
		$('#searchForm').attr('action', '<c:url value="/history/list/"/>' + pageIndex);
		$('#searchForm').submit();
	}
