                  ...
                  <div class="x_content">
                  	...
                  	<div class="container" style="padding: 50px;">
                  		<form:form modelAttribute="searchForm" 
							cssClass="form-horizontal form-label-left" servletRelativeAction="/goods-issue/list/1" method="POST">
...
<script type="text/javascript">
	...
	function goToPage(pageIndex) {
		$('#searchForm').attr('action', '<c:url value="/goods-issue/list/"/>' + pageIndex);
		$('#searchForm').submit();
	}
