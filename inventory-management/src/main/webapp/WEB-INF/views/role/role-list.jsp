                  ...
                  <div class="x_content">
                  	...
                  	<div class="container" style="padding: 50px;">
                  		<form:form modelAttribute="searchForm" 
							cssClass="form-horizontal form-label-left" servletRelativeAction="/role/list/1" method="POST">
							
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" for="roleName">Role Name</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<form:input path="roleName" cssClass="form-control col-md-7 col-xs-12" />
								</div>
							</div>
...
<script type="text/javascript">
	...
	function goToPage(pageIndex) {
		$('#searchForm').attr('action', '<c:url value="/role/list/"/>' + pageIndex);
		$('#searchForm').submit();
	}
