                  ...
                  <div class="x_content">
                  	...
                  	<div class="container" style="padding: 50px;">
                  		<form:form modelAttribute="searchForm" 
							cssClass="form-horizontal form-label-left" servletRelativeAction="/product-in-stock/list/1" method="POST">
...
<script type="text/javascript">
	...
	function goToPage(pageIndex) {
		$('#searchForm').attr('action', '<c:url value="/product-in-stock/list/"/>' + pageIndex);
		$('#searchForm').submit();
	}
</script>
