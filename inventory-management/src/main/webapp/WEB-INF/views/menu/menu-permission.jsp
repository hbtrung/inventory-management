				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="modelForm" 
							cssClass="form-horizontal form-label-left" servletRelativeAction="/menu/update-permission" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="has-error">
                						<form:errors path="menuId" cssClass="help-block"></form:errors>
                					</div>
								</div>
							</div>
							<div class="form-group">
